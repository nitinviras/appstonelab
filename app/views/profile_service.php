                ...
                <div class="col-md-3">
                    ...
                    <div class="author-profile_top right">
                        ...
                        <div class="sidebar-item author-bio">
                            <!-- USER AVATAR -->
                            <a href="<?php echo base_url('profile') . "/" . $user_record->user_login; ?>" class="user-avatar-wrap medium">
...
<script src="<?php echo base_url() . js_path ?>/module/author_service_list.js" type="text/javascript"></script>