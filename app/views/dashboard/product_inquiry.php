...
<div id="recommendation-popup" class="form-popup new-message mfp-hide">
    <!-- FORM POPUP CONTENT -->
    <div class="form-popup-content">
        ...
        <?php
        $attributes = array('id' => 'recommendation-form', 'name' => 'recommendation-form', 'method' => "post", "class" => "");
        echo form_open('send_rating', $attributes);
        ?>
        <!-- INPUT CONTAINER -->
        ...
        <!-- /INPUT CONTAINER -->
        <button type="button" id="rating_send" class="button mid dark">Save your <span class="primary">Recommendation</span></button>
        <?php echo form_close(); ?>
    </div>
    <!-- /FORM POPUP CONTENT -->
</div>
            ...
            <div id="product-sideshow" class="inquiry-product-sideshow">
                ...
                <div class="product-showcase tabbed">
                    ...
                    <div class="inbox-messages">
                        <!-- INBOX MESSAGE -->
                        <?php
                        if (isset($product_inquiry) && count($product_inquiry) > 0):
                            foreach ($product_inquiry as $value):
                            ...
                            <div class="inbox-message">
                                <div class="inbox-message-author not_inquiry" style="width: 100%;text-align: center">
                                    <p class="text-header text-center">
                                        No receive product inquiry found.
                                    </p>
                                </div>
                            </div>
                        <?php endif; ?>
                ...
                <div class="product-showcase tabbed">
                    ...
                    <div class="inbox-messages">
                        <!-- INBOX MESSAGE -->
                        <?php
                        if (isset($send_product_inquiry) && count($send_product_inquiry) > 0):
                            foreach ($send_product_inquiry as $value):
                                ...
                                <div class="inbox-message">
                                    ...
                                    <div class="inbox-recommand-content">
                                        <div class="recommendation-wrap">
                                            <?php
                                            if ($value['inquiry_from_id'] == $value['uid'] && $value['product_id'] == $value['pid']) {
                                                ?> 
                                                ...
                                                ?>
                                                <a onclick="get_rating_detail(this);" href="#recommendation-popup" class="recommendation good open-recommendation-form recommendation-popup" data-id="<?php echo $value['product_id']; ?>">
                                                    <span class="icon-like"></span>
                                                </a>
                                            <?php } ?>
                                        </div>
