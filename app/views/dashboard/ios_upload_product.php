...
<?php
$free = $paid = '';
$browsers = $fileincluded = $tag = $skill_options = array();
...
<div class="dashboard-content">
    ...
    <div class="container-fluid">
        ...
        <div class="headline simple primary fixed-box upalode-service">
            <h4>Upload Product : iOs</h4>
            <img src="<?php echo base_url() . img_path . "/ios.png"; ?>" alt="category" width="50px" height="50px" class="pull-right" style="margin: 5px 10px 0px;"/>
        ...
        <!-- /HEADLINE -->
        <?php echo form_open_multipart('ios_save_uploadproduct', array('name' => 'upload_form', 'id' => 'upload_form')); ?>
