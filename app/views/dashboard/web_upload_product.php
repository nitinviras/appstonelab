...
<?php
$yes = $no = $na = $free = $paid = '';
$options = $browsers = $fileincluded = $tag = $skill_options = array();
...
$sub_options['0'] = 'Select Category';
if (isset($parent_category_res) && !empty($parent_category_res)) {
    foreach ($parent_category_res as $row) {
        $sub_options[$row->ID] = ucfirst($row->title);
    }
}

$options['0'] = "Select Sub Category";
...
<div class="dashboard-content">
    ...
    <div class="container-fluid">
        ...
        <div class="headline simple primary fixed-box upalode-service">
            <h4>Upload Product : Web</h4>
            <img src="<?php echo base_url() . img_path . "/web.png"; ?>" alt="category" width="50px" height="50px" class="pull-right" style="margin: 5px 10px 0px;"/>
        ...
        <!-- /HEADLINE -->
        <?php echo form_open_multipart('web_save_uploadproduct', array('name' => 'upload_form', 'id' => 'upload_form')); ?>
                    ...
                    <div class="form-box-item">
                        ...
                        <div class="input-container">
                            ...
                            <label for="category" class="select-block">
                                <?php echo form_dropdown('category', $options, $category, 'id="category" require = ""'); ?>
                                <!-- SVG ARROW -->
                                <svg class="svg-arrow">
                                <use xlink:href="#svg-arrow"></use>
                                </svg>
                        ...
                        <div class="input-container">
                            ...
                            <label for="layout" class="select-block">
                                <?php echo form_dropdown('layout', $layouts, $layout, 'id="layout" require = ""'); ?>
                                <!-- SVG ARROW -->
                                <svg class="svg-arrow">
                                <use xlink:href="#svg-arrow"></use>
                                </svg>
                        ...
                        <div class="input-container">
                            ...
                            <label for="columns" class="select-block">
                                <?php echo form_dropdown('columns', $columns, $column, 'id="columns" require = ""'); ?>
                                <!-- SVG ARROW -->
                                <svg class="svg-arrow">
                                <use xlink:href="#svg-arrow"></use>
                                </svg>
                        ...
                        <div class="input-container">
                            ...
                            <div class="upload-file">
                                <div class="upload-file-actions">
                                    <a href="javascript:void(0)" class="button dark-light" id="main_browse">Upload File...</a><br/>
                                </div>
                            </div>
                            <!-- UPLOAD FILE -->
