                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="td-actions text-center">
                                                <a href="<?php echo base_url('insert_tag') . "?id=" . $row->ID; ?>" type="button" rel="tooltip" class="btn btn-success btn-round" data-original-title="" title="">
                                                    <i class="material-icons">mode_edit</i>
                                                </a>
                                                <a href="<?php echo base_url('tag_status') . "?id=" . $row->ID . "&status=" . $row->status; ?>" type="button" rel="tooltip" class="btn btn-info btn-round" data-original-title="" title="">
                                                    <i class="material-icons">visibility</i>
                                                </a>
                                                <a href="<?php echo base_url('delete_tag') . "?id=" . $row->ID; ?>" type="button" rel="tooltip" class="btn btn-danger btn-round" data-original-title="" title="">
