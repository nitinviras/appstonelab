                                ...
                                foreach ($pending as $row) {
                                        ...
                                        <tbody>
                                            ...
                                            <td class="td-actions text-center">
                                                <a href="<?php echo base_url('service_pending') . "?id=" . $row->ID . "&user_id=" . $row->user_id; ?>" type="button" rel="tooltip" class="btn btn-info btn-round" data-original-title="" title="">
                                    ...
                                    ?>
                                    <tr>
                                        <td colspan="6" align="center" style="color: red"><h4>No Pending Services  Found</h4></td>
                                    </tr>
                                    <?php
                                }
                                ?>
