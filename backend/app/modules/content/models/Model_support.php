...
class Model_support extends CI_Model {
    ...
    public function authenticate($username, $password) {
        ...
        if (is_array($record) && count($record) > 0) {
            ...
            $this->errorCode = 0;
            $this->errorMessage = 'Please check your email or password and try again.';
        }
...
//            pr($reply);exit;
    ...
    function check_username($username) {
        ...
        $error['Firstname'] = $list_data['Firstname'];
        $error['Lastname'] = $list_data['Lastname'];
