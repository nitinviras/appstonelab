                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example" >
                            <thead>
                                <tr>
                                        ...
                                        <th class="text-center">Product Sender</th>
                                        <th class="text-center">Product Receiver</th>
                                        <th class="text-center">Product Message</th>
                                        
                                </tr>
                            </thead>
                           <?php
                                $i = 1;
                               if (count($Product_inquiry) > 0) {
